            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 d-none d-md-block">
                        <p class="d-flex flex-wrap align-items-center text-gradient"><span class="hr-border d-none d-xl-block"></span>Let us help you for a better health.</p>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <ul class="select-box d-flex flex-wrap align-items-center justify-content-center justify-content-md-end">
                            <li class="select-item">
                                Cell: <a href="tel:08060162657">08060162657</a>
                            </li>
                            <li class="select-item">
                ...
                <div class="row align-items-center">
                    <div class="col">
                        <n-link to="/" class="brand-logo">
                            <img src="/images/logo/logo.png" alt="AARadiation" />
                        </n-link>
                    </div>
                    <div class="col-auto">
                        <div class="main-menu-wrapper">
                            ...
                            <n-link to="/contact" class="btn btn-warning btn-hover-warning btn-lg d-none d-md-block">
                                How can we help you? <i class="icofont-arrow-right"></i>
                            </n-link>
