                            ...
                            <div class="footer-row">
                                    ...
                                    <div class="footer-widget">
                                        ...
                                        <ul class="address">
                                            <li>
                                                ...
                                                <a href="tel:08060162657">08060162657</a>
                                            </li>
                                            <li>
                                                <span class="icon">
                                                    <i class="icofont-send-mail"></i>
                                                </span>
                                                <a href="mailto:info@aaradiantio.com">info@aaradiantio.com</a>
                                            </li>
                                            <li>
                                                <span class="icon">
                                ...
                                <div class="footer-col">
                                    <div class="footer-widget">
                                        ...
                                        <ul class="footer-menu">
                                            <li>
                                                <a class="footer-link" href="/service-details#radiotherapy">
                                                    <i class="icofont-rounded-double-right"></i>
                                                    Radiotherapy
                                                </a>
                                            </li>
                                            <li>
                                                <a class="footer-link" href="/service-details#diagnostic-imaging">
                                                    <i class="icofont-rounded-double-right"></i>
                                                    Diagnostic Imaging
                                                </a>
                                            </li>
                                            <li>
                                                <a class="footer-link" href="/service-details#nuclear-medicine">
                                                    <i class="icofont-rounded-double-right"></i>
                                                    Nuclear medicine
                                                </a>
                                            </li>
                                            <li>
                                                <a class="footer-link" href="/service-details#industrial-radiography">
                                                    <i class="icofont-rounded-double-right"></i>
                                                    Industrial radiography
                                                </a>
                                            </li>
                                            <li>
                                                <a class="footer-link" href="/service-details#enviromental-health">
                                                    <i class="icofont-rounded-double-right"></i>
                                ...
                                <div class="footer-col">
                                    <div class="footer-widget">
                                        ...
                                        <p>For updates and latest gigs, follow us on all our social media handles.</p>
